...
import { useAffiliateCommissions } from "@/api/affiliate";
import {
  PlatformPageHeader,
  PlatformCard,
  PlatformCardBody,
...
export default function AffiliateCommissionsPage() {
  ...
  return (
    <div className="plat-stack">
      <PlatformPageHeader
        title="Commissions"
        description="Suivi des commissions sur les paiements de vos parrainages."
      />

      {error && (
        <PlatformBanner>
          Impossible de charger les commissions. Vérifiez que la migration <code>026_affiliate_program.sql</code> est appliquée.
        </PlatformBanner>
      )}
                  ...
                  <div key={c.id} className="plat-list-item">
                    <div>
                      ...
                      <p className="plat-cell-muted text-xs">
                        Période {c.payment_period}/3 · {new Date(c.created_at).toLocaleDateString("fr-DZ")}
                      </p>
                    </div>
