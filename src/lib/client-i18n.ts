...
const messages = {
  en: {
    ...
    qrStatusCooldownHint: "Please wait before showing your QR again",
  ...
  fr: {
    ...
    qrStatusCooldownHint: "Patientez avant de présenter votre QR à nouveau",
  ...
  ar: {
    ...
    qrStatusCooldownHint: "يرجى الانتظار قبل عرض رمز QR مجدداً",
