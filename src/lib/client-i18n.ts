...
const messages = {
  en: {
    ...
    scanLimitCooldown: "Daily limit reached — scan again in",
    scanLimitHint: "{used}/{max} scans today — show this QR when the timer ends",
    qrStatusPending: "Visit in progress",
    qrStatusPendingHint: "Complete your purchase at the counter — staff will enter the amount or products",
    qrStatusSuccess: "Scan recorded!",
    qrStatusSuccessGeneric: "Your loyalty visit was saved",
    qrStatusSuccessStamp: "+{stamps} stamp(s) added",
    qrStatusSuccessSpend: "+{spend} DZD added to your total",
    qrStatusSuccessBoth: "+{stamps} stamp(s) and +{spend} DZD recorded",
    qrStatusBlockedLimit: "Daily scan limit reached",
    qrStatusCooldown: "Scanned too recently",
    qrStatusCooldownHint: "Just a few seconds — wait before showing your QR again",
    qrCooldownScan: "Scan again in",
    qrCooldownIn: "Available again in",
    qrCooldownPending: "Complete at counter within",
    qrCooldownUnavailable: "Unavailable",
    qrStatusBlocked: "Card cannot be scanned",
    qrStatusBlockedHint: "Contact the shop for assistance",
  },
  fr: {
    loading: "Chargement…",
    ...
    scanLimitCooldown: "Limite du jour — scan à nouveau dans",
    scanLimitHint: "{used}/{max} scans aujourd'hui — montrez ce QR quand le compteur arrive à 0",
    qrStatusPending: "Visite en cours",
    qrStatusPendingHint: "Finalisez votre achat au comptoir — le personnel saisira le montant ou les produits",
    qrStatusSuccess: "Scan enregistré !",
    qrStatusSuccessGeneric: "Votre visite fidélité a été enregistrée",
    qrStatusSuccessStamp: "+{stamps} tampon(s) ajouté(s)",
    qrStatusSuccessSpend: "+{spend} DA ajoutés à votre total",
    qrStatusSuccessBoth: "+{stamps} tampon(s) et +{spend} DA enregistrés",
    qrStatusBlockedLimit: "Limite de scans du jour atteinte",
    qrStatusCooldown: "Scan trop récent",
    qrStatusCooldownHint: "Quelques secondes seulement — patientez avant de présenter votre QR",
    qrCooldownScan: "Scan à nouveau dans",
    qrCooldownIn: "Disponible dans",
    qrCooldownPending: "Finalisez au comptoir sous",
    qrCooldownUnavailable: "Indisponible",
    qrStatusBlocked: "Carte non scannable",
    qrStatusBlockedHint: "Contactez le commerce pour obtenir de l'aide",
  },
  ar: {
    ...
    scanLimitCooldown: "الحد اليومي — امسح مجدداً خلال",
    scanLimitHint: "{used}/{max} مسحات اليوم — اعرض هذا QR عند انتهاء العداد",
    qrStatusPending: "زيارة قيد المعالجة",
    qrStatusPendingHint: "أكمل شراءك عند الكاشير — سيدخل الموظف المبلغ أو المنتجات",
    qrStatusSuccess: "تم تسجيل المسح!",
    qrStatusSuccessGeneric: "تم حفظ زيارتك للولاء",
    qrStatusSuccessStamp: "+{stamps} ختم(أختام) مضافة",
    qrStatusSuccessSpend: "+{spend} دج أضيفت إلى مجموعك",
    qrStatusSuccessBoth: "+{stamps} ختم(أختام) و +{spend} دج مسجلة",
    qrStatusBlockedLimit: "تم الوصول للحد اليومي للمسح",
    qrStatusCooldown: "مسح حديث جداً",
    qrStatusCooldownHint: "ثوانٍ قليلة فقط — انتظر قبل عرض رمز QR مجدداً",
    qrCooldownScan: "امسح مجدداً خلال",
    qrCooldownIn: "متاح مجدداً خلال",
    qrCooldownPending: "أكمل عند الكاشير خلال",
    qrCooldownUnavailable: "غير متاح",
    qrStatusBlocked: "لا يمكن مسح البطاقة",
    qrStatusBlockedHint: "تواصل مع المتجر للمساعدة",
  },
} as const;
