...
const messages = {
  en: {
    ...
    cardImageSaved: "Card image saved",
    cardImageFailed: "Could not save card image",
    copied: "Copied!",
    ...
    followUs: "Follow us",
    showStaffRewardQr: "Show this QR to staff to collect your prize",
    rewardReadyToClaim: "Prize ready!",
    openFullScreenReward: "Open full screen",
    rewardPhonePrompt: "Enter your phone number to show the staff QR code",
    rewardShowQr: "Show QR",
    rewardPhoneMismatch: "Phone number does not match this card",
    rewardPhonePromptShort: "Confirm your phone below to show QR",
    scanLimitCooldown: "Daily limit reached — available again in",
  },
  fr: {
    loading: "Chargement…",
    ...
    cardImageSaved: "Image de la carte enregistrée",
    cardImageFailed: "Impossible d'enregistrer l'image",
    copied: "Copié !",
    ...
    showStaffRewardQr: "Montrez ce QR au personnel pour récupérer votre prix",
    rewardReadyToClaim: "Prix à récupérer !",
    openFullScreenReward: "Ouvrir en plein écran",
    rewardPhonePrompt: "Saisissez votre numéro pour afficher le QR au personnel",
    rewardShowQr: "Afficher le QR",
    rewardPhoneMismatch: "Ce numéro ne correspond pas à cette carte",
    rewardPhonePromptShort: "Confirmez votre numéro ci-dessous pour le QR",
    scanLimitCooldown: "Limite du jour atteinte — disponible dans",
  },
  ar: {
    ...
    cardImageSaved: "تم حفظ صورة البطاقة",
    cardImageFailed: "تعذر حفظ صورة البطاقة",
    copied: "تم النسخ!",
    ...
    followUs: "تابعونا",
    showStaffRewardQr: "اعرض رمز QR للموظف لاستلام جائزتك",
    rewardReadyToClaim: "الجائزة جاهزة!",
    openFullScreenReward: "فتح بملء الشاشة",
    rewardPhonePrompt: "أدخل رقم هاتفك لعرض رمز QR للموظف",
    rewardShowQr: "عرض QR",
    rewardPhoneMismatch: "رقم الهاتف لا يطابق هذه البطاقة",
    rewardPhonePromptShort: "أكّد رقمك أدناه لعرض QR",
    scanLimitCooldown: "تم الوصول للحد اليومي — متاح مجدداً خلال",
  },
} as const;
