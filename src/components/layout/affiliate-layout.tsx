...
const navItems = [
  ...
  { label: "Parrainages", path: "/referrals", icon: Users },
    ...
    <div className="plat-shell">
      <div className="plat-layout">
        <aside className="plat-sidebar">
          ...
          <nav className="plat-nav" aria-label="Navigation affilié">
            {navItems.map((item) => {
        ...
        <div className="plat-main">
          <header className="plat-topbar">
            ...
            <div className="min-w-0 flex-1">
              <p className="plat-topbar-title">{currentPage?.label ?? "Affilié"}</p>
